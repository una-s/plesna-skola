...
public class StavkaEvidencijeCasova implements ApstraktniDomenskiObjekat {
    ...
    public StavkaEvidencijeCasova(EvidencijaCasova evidencijaCasova, Long rb, int ocena, Date datumPrisustva, String napomena, Cas cas) {
    ...
    public String vratiVrednostZaUbacivanje() {
        return "'" + new java.sql.Date(datumPrisustva.getTime()) + "', "
                + ocena + ", '"
                + napomena + "', "
                + evidencijaCasova.getIdEvidencijaCasova() + ", "
                + cas.getIdCas();
    }
...
// Proveri i vratiVrednostZaIzmenu ako je imaš
    ...
    public String vratiVrednostZaIzmenu() {
        return "datumPrisustva = '" + new java.sql.Date(datumPrisustva.getTime()) + "', "
                + "ocena = " + ocena + ", "
                + "napomena = '" + napomena + "', "
                + "cas = " + cas.getIdCas();
    }
