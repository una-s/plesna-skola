 ...
 * 
 * Svaki profesor ima ime, prezime, broj telefona, korisnicko ime i sifru koji
 * se koriste za prijavljivanje na sistem.
 * 
 * Implementira ApstraktniDomenskiObjekat za rad sa tabelom "profesor" u bazi
 * podataka.
 * 
...
public class Profesor implements ApstraktniDomenskiObjekat {
	 ...
	 * @param ime           Ime profesora. Ne sme biti null niti prazno.
	 * @param prezime       Prezime profesora. Ne sme biti null niti prazno.
	 * @param brojTelefona  Broj telefona profesora. Ne sme biti null niti prazan i
	 *                      mora sadrzati samo cifre.
	 * @param korisnickoIme Korisnicko ime za prijavljivanje. Ne sme biti null niti
	 *                      prazno.
	 * @param sifra         Sifra za prijavljivanje. Ne sme biti null niti prazna.
	 * @throws java.lang.NullPointerException     ako je bilo koje polje null.
	 * @throws java.lang.IllegalArgumentException ako je bilo koje polje prazno ili
	 *                                            ako broj telefona sadrzi znakove
	 *                                            koji nisu cifre.
	 */
	public Profesor(Long idProfesor, String ime, String prezime, String brojTelefona, String korisnickoIme,
			String sifra) {
	 ...
	 * 
	 * @param ime Novo ime profesora. Ne sme biti null niti prazno.
	 ...
	 * 
	 * @param prezime Novo prezime profesora. Ne sme biti null niti prazno.
	 ...
	 * 
	 * @param brojTelefona Novi broj telefona profesora. Ne sme biti null niti
	 *                     prazan i mora sadrzati samo cifre.
	 ...
	 * 
	 * @param korisnickoIme Novo korisnicko ime profesora. Ne sme biti null niti
	 *                      prazno.
	 * @throws java.lang.NullPointerException     ako je uneto korisnicko ime null.
	 * @throws java.lang.IllegalArgumentException ako je uneto korisnicko ime
	 *                                            prazno.
	 */
	 ...
	 * 
	 * @param sifra Nova sifra profesora. Ne sme biti null niti prazna.
	 ...
	 *         ako nemaju isto korisnicko ime i sifru.</li>
	 *         </ul>
	 */
	@Override
	 ...
	 * 
	 * Uslov se gradi od popunjenih polja - korisnickog imena i sifre, sa tacnim
	 * poklapanjem (koristi se prilikom prijavljivanja na sistem).
	 * 
	...
	public String vratiVrednostZaUbacivanje() {
		...
		sb.append("'").append(ime).append("', ").append("'").append(prezime).append("', ").append("'")
				.append(brojTelefona).append("', ").append("'").append(korisnickoIme).append("', ").append("'")
				.append(sifra).append("'");
		return sb.toString();
	}
	...
	public String vratiVrednostZaIzmenu() {
		...
		sb.append("ime = '").append(ime).append("', ").append("prezime = '").append(prezime).append("', ")
				.append("brojTelefona = '").append(brojTelefona).append("', ").append("korisnickoIme = '")
				.append(korisnickoIme).append("', ").append("sifra = '").append(sifra).append("'");
		return sb.toString();
	}
