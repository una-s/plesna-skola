...
/**
 * Predstavlja evidenciju casova jednog ucenika kod jednog profesora za
 * odredjenu skolsku godinu.
 * 
 * Sadrzi podatke o skolskoj godini, datumima pocetka i zavrsetka, profesoru,
 * uceniku i listi stavki evidencije (pojedinacnih casova).
 * 
 * Implementira ApstraktniDomenskiObjekat za rad sa tabelom "evidencija_casova"
 * u bazi podataka.
 * 
...
public class EvidencijaCasova implements ApstraktniDomenskiObjekat {
	...
	/**
	 * Kreira objekat klase EvidencijaCasova sa podrazumevanim (null) vrednostima.
	 */
	 ...
	 * 
	 * Poziva set metode za skolsku godinu, datume, profesora i ucenika uz logicku
	 * kontrolu.
	 * 
	 * @param idEvidencijaCasova Jedinstveni identifikator evidencije.
	 * @param skolskaGodina      Skolska godina u formatu "xxxx/xxxx". Ne sme biti
	 *                           null niti prazna.
	 * @param datumPocetka       Datum pocetka evidencije. Ne sme biti null.
	 * @param datumZavrsetka     Datum zavrsetka evidencije. Ne sme biti null.
	 ...
	 * @param profesor           Profesor koji vodi evidenciju. Ne sme biti null.
	 * @param ucenik             Ucenik na koga se evidencija odnosi. Ne sme biti
	 *                           null.
	 * @param stavke             Lista stavki evidencije.
	 * @throws java.lang.NullPointerException     ako je skolska godina, datum
	 *                                            pocetka, datum zavrsetka, profesor
	 *                                            ili ucenik null.
	 * @throws java.lang.IllegalArgumentException ako je skolska godina prazna.
	 */
	public EvidencijaCasova(Long idEvidencijaCasova, String skolskaGodina, Date datumPocetka, Date datumZavrsetka,
			int trajanjeEvidencije, double prosecnaOcena, int brojPrisustva, Profesor profesor, Ucenik ucenik,
		...
		setTrajanjeEvidencije(trajanjeEvidencije); 
		setProsecnaOcena(prosecnaOcena); 
		setBrojPrisustva(brojPrisustva); 
	 ...
	 * 
	 * @param skolskaGodina Nova skolska godina u formatu "xxxx/xxxx". Ne sme biti
	 *                      null niti prazna.
	 * @throws java.lang.NullPointerException     ako je uneta skolska godina null.
	 * @throws java.lang.IllegalArgumentException ako je uneta skolska godina
	 *                                            prazna.
	 */
	public void setSkolskaGodina(String skolskaGodina) {
		if (skolskaGodina == null) {
			throw new NullPointerException("Skolska godina ne sme biti null!");
		}
		if (skolskaGodina.isEmpty()) {
			throw new IllegalArgumentException("Skolska godina ne sme biti prazna!");
		}
	 ...
	 * 
	 * @param datumPocetka Novi datum pocetka. Ne sme biti null.
	 * @throws java.lang.NullPointerException ako je uneti datum pocetka null.
	 */
	 ...
	 * 
	 * @param datumZavrsetka Novi datum zavrsetka. Ne sme biti null.
	 * @throws java.lang.NullPointerException ako je uneti datum zavrsetka null.
	 */
	 ...
	 * 
	 * @param trajanjeEvidencije Novo trajanje evidencije. Ne sme biti negativno.
	 * @throws java.lang.IllegalArgumentException ako je trajanje negativno.
	 */
	public void setTrajanjeEvidencije(int trajanjeEvidencije) {
		if (trajanjeEvidencije < 0) {
			throw new IllegalArgumentException("Trajanje evidencije ne sme biti negativno!");
		}
	 ...
	 * 
	 * @param prosecnaOcena Nova prosecna ocena. Mora biti izmedju 0 i 5.
	 * @throws java.lang.IllegalArgumentException ako prosecna ocena nije izmedju 0
	 *                                            i 5.
	 */
	public void setProsecnaOcena(double prosecnaOcena) {
		if (prosecnaOcena < 0 || prosecnaOcena > 5) {
			throw new IllegalArgumentException("Prosecna ocena mora biti izmedju 0 i 5!");
		}
	 ...
	 * 
	 * @param brojPrisustva Novi broj prisustava. Ne sme biti negativan.
	 * @throws java.lang.IllegalArgumentException ako je broj prisustava negativan.
	 */
	public void setBrojPrisustva(int brojPrisustva) {
		if (brojPrisustva < 0) {
			throw new IllegalArgumentException("Broj prisustava ne sme biti negativan!");
		}
	 ...
	 * 
	 * @param profesor Novi profesor. Ne sme biti null.
	 * @throws java.lang.NullPointerException ako je uneti profesor null.
	 */
	 ...
	 * 
	 * @param ucenik Novi ucenik. Ne sme biti null.
	 * @throws java.lang.NullPointerException ako je uneti ucenik null.
	 */
	public void setUcenik(Ucenik ucenik) {
		if (ucenik == null) {
			throw new NullPointerException("Ucenik ne sme biti null!");
		}
		this.ucenik = ucenik;
	}
	...
	/**
	 * Vraca String reprezentaciju evidencije casova sa skolskom godinom, ucenikom i
	 * profesorom.
	 * 
	 * @return podaci o evidenciji u formatu "Skolska godina: ####, Ucenik: ####,
	 *         Profesor: ####".
	 */
	@Override
	 ...
	 * @return
	 *         <ul>
	 *         <li><b>true</b> - ako su oba objekta klase EvidencijaCasova sa istim
	 *         identifikatorom ili ako su na istoj adresi.</li>
	 *         <li><b>false</b> - ako je drugi objekat null, ako je druge klase ili
	 *         ako nemaju isti identifikator.</li>
	 *         </ul>
	 */
	@Override
	...
	@Override
	public String join() {
		return "JOIN profesor p ON ec.profesor = p.idProfesor " + "JOIN ucenik u ON ec.ucenik = u.idUcenik "
				+ "JOIN plesni_nivo pn ON pn.idPlesniNivo = u.idPlesniNivo ";
	}

	@Override
	public String vratiVrednostZaUbacivanje() {
		return "'" + skolskaGodina + "', '" + new java.sql.Date(datumPocetka.getTime()) + "', '"
				+ new java.sql.Date(datumZavrsetka.getTime()) + "', " + profesor.getIdProfesor() + ", "
				+ ucenik.getIdUcenik();
	...
	public String vratiVrednostZaIzmenu() {
		return "skolskaGodina = '" + skolskaGodina + "', " + "datumPocetka = '"
				+ new java.sql.Date(datumPocetka.getTime()) + "', " + "datumZavrsetka = '"
				+ new java.sql.Date(datumZavrsetka.getTime()) + "', " + "profesor = " + profesor.getIdProfesor() + ", "
	 ...
	 * 
	 * Ako je postavljen identifikator (veci od nule), pretraga se vrsi samo po
	 * identifikatoru. U suprotnom, uslov se gradi na osnovu popunjenih polja:
	 * profesora, ucenika i skolske godine.
	 * 
	 * @return uslov za pretragu kao String ili prazan String ako nijedan kriterijum
	 *         nije popunjen.
	 */
	@Override
	...
	private EvidencijaCasova ocitajIzRS(ResultSet rs) throws Exception {
		...
		return new EvidencijaCasova(idEvidencija, skolskaGod, datPocetka, datZavrsetka, trajanje, prosOcena,
				brPrisustva, profesor, ucenik, null);
	}
