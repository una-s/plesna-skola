 ...
 * 
 * Implementira ApstraktniDomenskiObjekat za rad sa tabelom "pr_s" u bazi
 * podataka.
 * 
...
public class PrS implements ApstraktniDomenskiObjekat {
	 ...
	 * 
	 * @param datumIzdavanja Datum izdavanja sertifikata. Ne sme biti null.
	 * @param profesor       Profesor koji je stekao sertifikat. Ne sme biti null.
	 * @param sertifikat     Sertifikat koji je profesor stekao. Ne sme biti null.
	 * @throws java.lang.NullPointerException ako je datum izdavanja, profesor ili
	 *                                        sertifikat null.
	 */
	 ...
	 * 
	 * @param datumIzdavanja Novi datum izdavanja. Ne sme biti null.
	 ...
	 * 
	 * @param sertifikat Novi sertifikat. Ne sme biti null.
	 * @throws java.lang.NullPointerException ako je uneti sertifikat null.
	 */
	...
	/**
	 * Vraca hash kod veze izracunat na osnovu datuma izdavanja, profesora i
	 * sertifikata.
	 * 
	 ...
	 *         ako nemaju iste vrednosti sva tri polja.</li>
	 *         </ul>
	 */
	@Override
	...
	public String vratiVrednostZaUbacivanje() {
		...
		sb.append(profesor.getIdProfesor()).append(", ").append(sertifikat.getIdSertifikat()).append(", ").append("'")
				.append(new java.sql.Date(datumIzdavanja.getTime())).append("'");
		return sb.toString();
	}
	...
	public String vratiVrednostZaIzmenu() {
		StringBuilder sb = new StringBuilder();
		sb.append("profesor = ").append(profesor.getIdProfesor()).append(", ").append("sertifikat = ")
				.append(sertifikat.getIdSertifikat()).append(", ").append("datumIzdavanja = '")
				.append(new java.sql.Date(datumIzdavanja.getTime())).append("'");
		return sb.toString();
	}
	...
	public String vratiPrimarniKljuc() {
		return "profesor = " + profesor.getIdProfesor() + " AND sertifikat = " + sertifikat.getIdSertifikat()
