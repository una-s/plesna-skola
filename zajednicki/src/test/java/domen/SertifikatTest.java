...
class SertifikatTest {
	...
	/**
	 * Test method for {@link domen.Sertifikat#Sertifikat(java.lang.Long, java.lang.String, java.lang.String)}.
	 */
	@Test
    ...
    @CsvSource({
        "Plesna Akademija Korak, Salsa, Plesna Akademija Korak, Salsa, true",
	...
	@Test
	 void testToString() {
        ...
        assertEquals("Salsa instruktor FON", s.toString());
	}
